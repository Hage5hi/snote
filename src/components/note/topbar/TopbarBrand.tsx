// Brand block on the left of the Topbar: home link, slug, copy-URL, status pill, tag chips.
...
export function TopbarBrand({ slug, doc, isEncrypted, status, onOpenHistory }: TopbarBrandProps) {
  const copyUrl = async () => {
