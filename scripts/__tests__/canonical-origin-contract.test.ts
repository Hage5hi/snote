...
describe("canonical production origin", () => {
  ...
  it("labels capability security as a deferred target instead of live production", () => {
    ...
    expect(readme).toContain("e39caacd");
    ...
    expect(findings).toContain("Origin is `e39caacd`");
  ...
  it("pins leftover client/Worker present-tense surfaces to live origin canary e39caacd", () => {
    ...
    expect(client).toContain("e39caacd");
    ...
    expect(worker).toContain("`e39caacd`");
