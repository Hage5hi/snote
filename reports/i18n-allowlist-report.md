...
| 4 | `src/pages/NotePage.tsx` | SEO control value | ✅ | `src/pages/NotePage.tsx:806`<br>`src/pages/NotePage.tsx:810` |
| 5 | `src/pages/RawView.tsx` | SEO control value | ✅ | `src/pages/RawView.tsx:114` |
| 6 | `src/pages/SharePage.tsx` | crawler-facing SEO copy (page is noindex) | ✅ | `src/pages/SharePage.tsx:411` |
| 7 | `src/pages/SplitView.tsx` | SEO control value | ✅ | `src/pages/SplitView.tsx:137` |
